"""
Script for testing Sparsefool on trianed models
input : images (.jpg/.jpeg), output path, number of images in input, maximum nuber of iterations for sparsefool + 1,
a boolean fixed_iter (cf sparsefool)
output : fooled images, added nooise images, accuracy, average nuber of pixels changed
"""
...
def sparsefool_generate(model_path, input_path,output_path,num=100,delta=100 ,max_iter=25, fixed_iter=False):
    ...
    # Summarize results for all images
...
if __name__ == "__main__":
    sparsefool_generate("./Models_trained/2layers.pth", "./data/input/", "./output/", num=100, delta=25, max_iter=20)